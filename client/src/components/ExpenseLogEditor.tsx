...
export function ExpenseLogEditor({ expenseLogId, propertyId, initialBreakdown, onSave }: ExpenseLogEditorProps) {
  ...
  const updateFrequency = (category: string, frequency: "Weekly" | "Monthly" | "Quarterly" | "Annually") => {
    setExpenses(prev => ({
      ...prev,
      [category]: {
        ...prev[category],
            ...
            <div className="flex gap-2 flex-1">
              ...
              <div className="w-32">
                ...
                <Select
                  ...
                  onValueChange={(value) => updateFrequency(category, value as "Weekly" | "Monthly" | "Quarterly" | "Annually")}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
